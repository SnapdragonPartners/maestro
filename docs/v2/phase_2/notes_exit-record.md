...
**Resolved 2026-08-08, after this record closed:** ADR 0020 was amended to define model lineage as the originating lab and to state a three-rung degradation ladder that warns and never refuses. Candidate 16 is closed for the rule; the machinery above is deliberately not built — the author/reviewer pairing graph it would read is a Phase 5 deliverable — and is carried as tracked work.
