...
- [Maestro v2 Phase 1: Scope And Plan](plan_scope.md) — Proposed Phase 1 scope and execution plan: 11 serial work items covering the runner module, fixtures, the v1-as-patched target, the single-agent baseline, D9 cost instrumentation, and the first 5-10 stories.
