...
- [Design: The v1-As-Patched Adapter (Item 4)](design_adapter_v1.md) — Design sketch for the adapter-v1 work item: per-run Gitea forge isolation (SWE-EVO salvage), subprocess invocation and DB-poll lifecycle, poll-streamed budget enforcement, honest metric normalization from maestro.db, the templates-manifest prompt hash, and two small engine contract additions.
