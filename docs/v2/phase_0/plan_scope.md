...
Goal (from the [roadmap](../plan_roadmap.md)): decide the conceptual shape before code churn.
...
- Reconciled, dependency-ordered ADR backlog (supersedes the interim priority list in [notes_v1-adr-alignment.md](../notes_v1-adr-alignment.md)).
...
| 10 | `port-inventory` | The D8 port/rework/rewrite/drop inventory at package grain over the actual v1 package list, using the spike results (items 8, 9, and 13). Records breaking-change principles. | M |
