...
Status: Accepted (Codex + DR, 2026-07-13); amended 2026-07-14 (local durability invariant; config and secrets resolved into the plane with an external root of trust; backup contract); amended 2026-07-29 (cross-store commit order restated in schema-implementable terms, enforced at acceptance); amended 2026-09-24 (the named object-store fallback exercised: SeaweedFS replaces MinIO as the local adapter — PROPOSED until Codex and DR accept the fix branch)
