...
newline-delimited JSON with it. Thirty-nine of the sixty claims do; the
remaining twenty-one exercise boundary and schema properties the wire scenarios depend
