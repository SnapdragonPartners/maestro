...
func (m *MockGitRunner) Run(_ context.Context, dir string, args ...string) ([]byte, error) {
	// Log the call.
...
func (m *MockGitRunner) RunQuiet(_ context.Context, dir string, args ...string) ([]byte, error) {
