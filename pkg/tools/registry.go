...
func init() {
	...
	Register(ToolContainerRun, createContainerRunTool, &ToolMeta{
		Name:        ToolContainerRun,
		Description: "Run a container for testing and validation",
		InputSchema: getContainerRunSchema(),
	})
