...
type ApprovalRequestPayload struct {
	...
	InfrastructureSpec    string            `json:"infrastructure_spec,omitempty"`    // DEPRECATED: Use BootstrapRequirements instead
	BootstrapRequirements []string          `json:"bootstrap_requirements,omitempty"` // Bootstrap requirement IDs - architect renders full spec
